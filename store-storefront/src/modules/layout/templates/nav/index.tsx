...
export default async function Nav() {
  ...
  return (
    <div className="sticky top-0 inset-x-0 z-50 bg-white/95 backdrop-blur-sm border-b border-primary-200">
        ...
        <nav className="content-container flex items-center justify-between w-full h-full px-6">
          ...
          <div className="flex items-center gap-x-6 h-full flex-1 basis-0 justify-end">
            ...
            <Suspense
              fallback={
                <LocalizedClientLink
                  className="text-primary-700 hover:text-accent-600 transition-colors duration-200 flex gap-2"
                  href="/cart"
